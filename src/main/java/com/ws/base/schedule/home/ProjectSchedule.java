package com.ws.base.schedule.home;

import com.ws.base.bean.EarnestMoneyStatus;
import com.ws.base.bean.ProjectStatus;
import com.ws.base.bean.RemindType;
import com.ws.base.service.admin.BiddingProjectService;
import com.ws.base.service.home.BiddingRecordService;
import com.ws.base.util.SendEmailUtil;
import com.ws.base.entity.common.BiddingProject;
import com.ws.base.entity.home.BiddingApply;
import com.ws.base.entity.home.BiddingRecord;
import com.ws.base.entity.home.BiddingRemind;
import com.ws.base.service.home.BiddingApplyService;
import com.ws.base.service.home.BiddingRemindService;
...
public class ProjectSchedule {
    ...
    public SendEmailUtil sendEmailUtil(String email, String title) throws Exception {
        ...
        sendEmailUtil.sendMsg("在线竞拍：你设置提醒的项目:<" + title + ">已开始竞拍。");//发送信息
