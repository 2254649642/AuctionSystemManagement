package com.ws.base.service.admin;
import java.io.File;
import java.io.IOException;
import java.util.Date;

import com.ws.base.bean.PageBean;
import com.ws.base.dao.admin.DatabaseBakDao;
import com.ws.base.entity.admin.DatabaseBak;
...
public class DatabaseBakService {
	...
	@Value("${ws.database.backup.dir}")
	private String backUpDir;
	@Value("${ws.database.backup.username}")
	private String dbUsername;
	@Value("${ws.database.backup.password}")
	private String dbPwd;
	@Value("${ws.database.backup.database.name}")
